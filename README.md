...
# Download e contatti
Nella sezione [release](https://github.com/RiccardoPerina/TestRegesta_RiccardoPerina/releases/tag/TestRegesta) puoi trovare l'ultima versione del programma.
