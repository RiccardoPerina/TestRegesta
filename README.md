...
# Download e contatti
Nella sezione [release](https://github.com/RiccardoPerina/TestRegesta/releases/tag/TestRegesta_RiccardoPerina) puoi trovare l'ultima versione del programma.
